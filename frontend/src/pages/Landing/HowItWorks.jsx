...
import { Cpu, ArrowDown, Database, Cpu as ModelIcon, TrendingUp, AlertCircle, HelpCircle, Sun, Moon } from 'lucide-react';
    ...
    <div style={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', minHeight: '100vh' }}>
      ...
      <header className="landing-header">
        ...
        <nav className="hide-on-mobile" style={{ display: 'flex', gap: '24px' }}>
          ...
          <Link to="/how-it-works" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: '600', fontSize: '0.9rem' }}>How It Works</Link>
